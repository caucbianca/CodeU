...
public class BinaryTree<T> {
	...
	public void addNode(T key, T parentKey, boolean isLeft) {
			...
			if (currentNode.getKey() == parentKey) {
				...
				if (isLeft == true) {
					if (currentNode.left != null) {
						System.out.println("WARNING: The node " + currentNode.left.getKey() + 
				...
				/* Add the new node to the right */
					...
					if (currentNode.right != null) {
						System.out.println("WARNING: The node " + currentNode.right.getKey() + 
								" is going to be replaced!");
					}
		 ...
		 * the new node can't be inserted in the tree */
